import {
  attachAIRouteMetaHeaders,
  buildAIRouteResponseMetaHeaders,
} from "@/domain/AIRouteResponseMeta";
 ...
 *
 * AIRoute forwards upstream response headers verbatim. If we re-emit those
...
export function buildStreamingResponseHeaders(
  ...
  attachAIRouteMetaHeaders(responseHeaders, meta);
