# 🚀 AIRoute — Gateway AI Gratis (Bahasa Indonesia)
...
[![npm version](https://img.shields.io/npm/v/AIRoute?color=cb3837&logo=npm)](https://www.npmjs.com/package/AIRoute)
[![Docker Hub](https://img.shields.io/docker/v/diegosouzapw/AIRoute?label=Docker%20Hub&logo=docker&color=2496ED)](https://hub.docker.com/r/diegosouzapw/AIRoute)

![NPM Downloads](https://img.shields.io/npm/dw/AIRoute?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/AIRoute?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/AIRoute?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/AIRoute)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/diegosouzapw/AIRoute/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/diegosouzapw/AIRoute?logo=star&style=flat)](https://github.com/diegosouzapw/AIRoute/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/diegosouzapw/AIRoute?logo=issue)](https://github.com/diegosouzapw/AIRoute/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/diegosouzapw/AIRoute?logo=law)](https://github.com/diegosouzapw/AIRoute/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/diegosouzapw/AIRoute?logo=history&logoColor=white)](https://github.com/diegosouzapw/AIRoute/commits/main)
...
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/diegosouzapw/AIRoute?logo=file-code&logoColor=white)](https://github.com/diegosouzapw/AIRoute)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/diegosouzapw/AIRoute?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/diegosouzapw/AIRoute/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/diegosouzapw/AIRoute?logo=tag&logoColor=white)](https://github.com/diegosouzapw/AIRoute/tags)
...
[![fork](https://custom-icon-badges.demolab.com/github/forks/diegosouzapw/AIRoute?logo=fork)](https://github.com/diegosouzapw/AIRoute/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/diegosouzapw/AIRoute?logo=eye)](https://github.com/diegosouzapw/AIRoute/watchers)

[![License](https://img.shields.io/github/license/diegosouzapw/AIRoute)](https://github.com/diegosouzapw/AIRoute/blob/main/LICENSE)
[![Website](https://img.shields.io/badge/Website-AIRoute.online-blue?logo=google-chrome&logoColor=white)](https://AIRoute.online)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-Community-25D366?logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)

[🌐 Website](https://AIRoute.online) • [🚀 Mulai Cepat](#-quick-start) • [💡 Fitur](#-key-features) • [📖 Dokumentasi](#-documentation) • [💰 Harga](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainAIRoute.png" alt="AIRoute Dashboard" width="800"/>
</div>
...
_Hubungkan IDE atau alat CLI berbasis AI apa pun melalui AIRoute — gateway API gratis untuk coding tanpa batas._
...
<sub>📡 Semua agen terhubung melalui <code>http://localhost:20128/v1</code> atau <code>http://cloud.AIRoute.online/v1</code> — satu konfigurasi, model dan kuota tak terbatas</sub>
...
- **Website**: [AIRoute.online](https://AIRoute.online)
- **GitHub**: [github.com/diegosouzapw/AIRoute](https://github.com/diegosouzapw/AIRoute)
- **Issues**: [github.com/diegosouzapw/AIRoute/issues](https://github.com/diegosouzapw/AIRoute/issues)
...
## 🎯 Apa yang Diselesaikan AIRoute — 30 Masalah Nyata & Kasus Penggunaan

> **Setiap developer yang menggunakan alat AI menghadapi masalah ini setiap hari.** AIRoute dibangun untuk menyelesaikannya semua — dari pembengkakan biaya hingga pemblokiran regional, dari alur OAuth yang rusak hingga operasi protokol dan observabilitas enterprise.
...
**Bagaimana AIRoute menyelesaikannya:**
...
- **Laporan Info Sistem** — `npm run system-info` menghasilkan `system-info.txt` dengan lingkungan lengkap Anda (versi Node, versi AIRoute, OS, alat CLI, status Docker/PM2). Lampirkan saat melaporkan masalah untuk triase instan.
...
- **instal global npm** — `npm install -g AIRoute && AIRoute` — selesai
...
- Mulai cepat bawaan untuk `AIRoute --mcp` dan orientasi klien
...
```txt
1) Start MCP transport (`AIRoute --mcp`) for tool-driven operations
...
>
> ```bash
> pnpm add -g AIRoute@latest --allow-build=better-sqlite3 --allow-build=@swc/core
> AIRoute
> ```
...
Pengguna Arch Linux dapat menginstal [AUR package](https://aur.archlinux.org/packages/AIRoute-bin), yang menginstal AIRoute dan menyediakan layanan pengguna systemd:

```bash
yay -S AIRoute-bin
systemctl --user enable --now AIRoute.service
```

| Command                 | Description                                                     |
| ----------------------- | --------------------------------------------------------------- |
| `AIRoute`             | Mulai server (`PORT=20128`, API dan dasbor pada port yang sama) |
| `AIRoute --port 3000` | Set canonical/API port to 3000                                  |
| `AIRoute --mcp`       | Mulai server MCP (stdio transport)                              |
| `AIRoute --no-open`   | Don't auto-open browser                                         |
| `AIRoute --help`      | Show help                                                       |

Optional split-port mode:

```bash
PORT=20128 DASHBOARD_PORT=20129 AIRoute
...
Saat Anda tidak lagi memerlukan AIRoute, kami menyediakan dua skrip cepat untuk penghapusan bersih:

| Command                  | Action                                                                                       |
| ------------------------ | -------------------------------------------------------------------------------------------- |
| `npm run uninstall`      | Menghapus aplikasi sistem tetapi **menyimpan DB dan konfigurasi Anda** di `~/.AIRoute`.    |
| `npm run uninstall:full` | Menghapus aplikasi DAN secara permanen **menghapus semua konfigurasi, kunci, dan database**. |

> Catatan: Untuk menjalankan perintah ini, navigasikan ke folder proyek AIRoute (jika Anda mengkloningnya) dan jalankan. Alternatifnya, jika diinstal secara global, Anda cukup menjalankan `npm uninstall -g AIRoute`.
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Kesenjangan maksimum antara potongan streaming sebelum AIRoute membatalkan aliran SSE                                                                                      |
...
Untuk upstream yang kompatibel dengan Kode Claude (`anthropic-compatible-cc-*`), AIRoute juga memperoleh header `X-Stainless-Timeout` keluar dari batas waktu pengambilan yang diselesaikan sehingga batas waktu baca sisi penyedia tetap selaras dengan konfigurasi env Anda.

Untuk reverse proxy pihak ketiga yang kompatibel dengan Claude Code, AIRoute tetap menggunakan default
...
`cache_control`, AIRoute tidak memasukkan penanda milik jembatan.
...
Untuk permintaan streaming, `FETCH_TIMEOUT_MS` hanya mencakup pengaturan koneksi/menunggu respons upstream pertama. Setelah aliran aktif, AIRoute hanya akan dibatalkan pada keadaan terhenti sebenarnya (`STREAM_IDLE_TIMEOUT_MS`) atau tubuh Undici tidak aktif (`FETCH_BODY_TIMEOUT_MS`).

Jika Anda menjalankan AIRoute di belakang Nginx, Caddy, Cloudflare, atau proksi terbalik lainnya, pastikan proksi tersebut
waktu tunggu juga lebih tinggi daripada waktu tunggu aliran/pengambilan AIRoute Anda.
...
### 3) Arahkan alat pengkodean Anda ke AIRoute
...
Untuk pengguna Void Linux, Anda dapat membuat paket asli menggunakan `xbps-src`. Simpan blok ini sebagai `srcpkgs/AIRoute/template`:

```bash
# Template file for 'AIRoute'
pkgname=AIRoute
version=3.4.1
revision=1
...
license="MIT"
homepage="https://github.com/diegosouzapw/AIRoute"
distfiles="https://github.com/diegosouzapw/AIRoute/archive/refs/tags/v${version}.tar.gz"
checksum=009400afee90a9f32599d8fe734145cfd84098140b7287990183dde45ae2245b
system_accounts="_AIRoute"
AIRoute_homedir="/var/lib/AIRoute"
...
do_install() {
	vmkdir usr/lib/AIRoute/.next

	vcopy .next/standalone/. usr/lib/AIRoute/.next/standalone
	...
	for _d in \
		...
		touch "${DESTDIR}/usr/lib/AIRoute/${_d}/.keep"
	done

	cat > "${WRKDIR}/AIRoute" <<'EOF'
#!/bin/sh
export PORT="${PORT:-20128}"
export DATA_DIR="${DATA_DIR:-${XDG_DATA_HOME:-${HOME}/.local/share}/AIRoute}"
export APP_LOG_TO_FILE="${APP_LOG_TO_FILE:-false}"
mkdir -p "${DATA_DIR}"
exec node /usr/lib/AIRoute/.next/standalone/server.js "$@"
EOF
	vbin "${WRKDIR}/AIRoute"
}
...
AIRoute tersedia sebagai image Docker publik di [Docker Hub](https://hub.docker.com/r/diegosouzapw/AIRoute).
...
- Terowongan Cepat tidak dipulihkan secara otomatis setelah AIRoute atau kontainer dimulai ulang. Aktifkan kembali dari dasbor bila diperlukan.
...
- SQLite berjalan dalam mode WAL. `docker stop` harus dibiarkan selesai sehingga AIRoute dapat memeriksa kembali perubahan terbaru ke `storage.sqlite`.
...
- Setel `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` jika Anda ingin AIRoute menggunakan biner yang sudah ada alih-alih mengunduhnya.

**Menggunakan Docker Compose dengan Caddy (HTTPS Auto-TLS):**

AIRoute dapat diekspos dengan aman menggunakan penyediaan SSL otomatis Caddy. Pastikan data DNS A domain Anda mengarah ke IP server Anda.

```yaml
services:
  AIRoute:
    image: diegosouzapw/AIRoute:latest
    container_name: AIRoute
    restart: unless-stopped
    volumes:
      - AIRoute-data:/app/data
    environment:
      - PORT=20128
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://AIRoute:20128
...
| ------------------------ | -------- | ------ | --------------------- |
| `diegosouzapw/AIRoute` | `latest` | ~250MB | Latest stable release |
| `diegosouzapw/AIRoute` | `3.6.2`  | ~250MB | Current version       |

---

## 🖥️ Aplikasi Desktop — Offline & Selalu Aktif

> 🆕 **BARU!** AIRoute kini tersedia sebagai **aplikasi desktop asli** untuk Windows, macOS, dan Linux.

Jalankan AIRoute sebagai aplikasi desktop mandiri — tanpa terminal, tanpa browser, tanpa internet untuk model lokal. Aplikasi berbasis Electron meliputi:

- 🖥️ **Jendela Asli** — Jendela aplikasi khusus dengan integrasi baki sistem
- 🔄 **Mulai Otomatis** — Luncurkan AIRoute saat login sistem
...
Saat diminimalkan, AIRoute ada di baki sistem Anda dengan tindakan cepat:
...
**Tanpa biaya. Jangan pernah berhenti melakukan pengkodean.** Konfigurasikan ini sebagai satu kombo AIRoute dan semua fallback terjadi secara otomatis — tidak pernah ada peralihan manual.
...
> Semua model di bawah **100% gratis tanpa memerlukan kartu kredit**. AIRoute melakukan rute otomatis di antara keduanya ketika satu kuota habis — gabungkan semuanya untuk kombo $0 yang tidak dapat dipecahkan.
...
AIRoute v3.6 dibangun sebagai platform operasional, bukan hanya proxy relai.
...
Ketika kuota, tarif, atau kesehatan gagal, AIRoute secara otomatis berpindah ke kandidat berikutnya tanpa peralihan manual.
...
AIRoute menyertakan kerangka evaluasi bawaan untuk menguji kualitas respons LLM terhadap rangkaian emas. Akses melalui **Analytics → Evals** di dasbor.

### Golden Set Bawaan

"AIRoute Golden Set" yang dimuat sebelumnya berisi kasus uji untuk:
...
2. Jalankan `AIRoute_get_health`.
3. Jalankan `AIRoute_list_combos`.
...
**Kiat Pro:** Gunakan Opus untuk tugas kompleks, Soneta untuk kecepatan. AIRoute melacak kuota per model!
...
- Perilaku rotasi: AIRoute merutekan ke akun Codex berikutnya yang memenuhi syarat secara otomatis.
...
**Kiat Pro:** API yang kompatibel dengan OpenAI — bekerja secara lancar dengan terjemahan format AIRoute!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from AIRoute dashboard]
...
export OPENAI_API_KEY="your-AIRoute-api-key"
...
> **Catatan:** OpenClaw hanya berfungsi dengan AIRoute lokal. Gunakan `127.0.0.1` alih-alih `localhost` untuk menghindari masalah resolusi IPv6.
...
Settings → API Configuration:
  ...
  Base URL: http://localhost:20128/v1
  API Key: [from AIRoute dashboard]
  Model: if/kimi-k2-thinking
```

### OpenCode

**Langkah 1:** Tambahkan AIRoute sebagai penyedia khusus:

```bash
opencode
/connect
# Select "Other" → Enter ID: "AIRoute" → Enter your AIRoute API key
```
...
```bash
/models
# Select any AIRoute model from the list
```

> **Tips:** Tambahkan model apa pun yang tersedia di titik akhir AIRoute `/v1/models` Anda ke bagian `models`. Gunakan format `provider/model-id` dari dasbor AIRoute Anda.
...
- Disegarkan secara otomatis oleh AIRoute
...
- AIRoute v1.0.6+ menyertakan validasi fallback melalui penyelesaian obrolan
...
> **⚠️ Penting bagi pengguna yang menjalankan AIRoute di VPS, Docker, atau server jarak jauh mana pun**

Kredensial OAuth yang disertakan dalam AIRoute didaftarkan **hanya untuk `localhost`**. Saat Anda mengakses AIRoute di server jarak jauh (misalnya `https://AIRoute.myserver.com`), Google menolak autentikasi dengan:
...
- Nama: apa pun yang Anda suka (mis. `AIRoute Remote`)
...
1. AIRoute membuka URL otorisasi Google
...
4. Tempelkan URL tersebut ke bidang yang ditampilkan di modal koneksi AIRoute
5. Klik **"Hubungkan"**
...
- **Situs Web**: [AIRoute.online](https://AIRoute.online)
- **Paket**: [npmjs.com/package/AIRoute](https://www.npmjs.com/package/AIRoute)
- **Pekerja Pelabuhan**: [hub.docker.com/r/diegosouzapw/AIRoute](https://hub.docker.com/r/diegosouzapw/AIRoute)
...
AIRoute memiliki **218+ fitur yang direncanakan** di berbagai fase pengembangan. Berikut adalah bidang-bidang utamanya:
...
[![Contributors](https://contrib.rocks/image?repo=diegosouzapw/AIRoute&max=100&columns=20&anon=1)](https://github.com/diegosouzapw/AIRoute/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=diegosouzapw%2FAIRoute&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/AIRoute&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/AIRoute&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=diegosouzapw/AIRoute&type=date&legend=top-left" />
 </picture>
</a>

## 🌍 StarMapper

<a href="https://starmapper.bruniaux.com/diegosouzapw/AIRoute">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/AIRoute?theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/AIRoute?theme=light" />
    <img alt="StarMapper" src="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/AIRoute" />
  </picture>
</a>
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://AIRoute.online">AIRoute.online</a></sub>
</div>
