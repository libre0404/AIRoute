# AIRoute — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi AIRoute pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout AIRoute Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [AIRouteCloud/README.md](../AIRouteCloud/README.md).
...
| 20128 | AIRoute   | Hanya localhost (melalui nginx) |
