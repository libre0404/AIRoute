...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AIRoute Documentation",
    description:
      "Comprehensive docs for AIRoute AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://AIRoute.online/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "AIRoute Documentation",
    description: "Comprehensive docs for AIRoute AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get AIRoute running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let AIRoute pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">AIRoute Documentation</h1>
