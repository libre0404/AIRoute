...
import { huaweiProvider } from "./registry/huawei/index.ts";
import { huawei_cnProvider } from "./registry/huawei-cn/index.ts";
import { coze_botProvider } from "./registry/coze-bot/index.ts";
import { dify_workflowProvider } from "./registry/dify-workflow/index.ts";
...
export const REGISTRY: Record<string, RegistryEntry> = {
  ...
  "huawei-cn": huawei_cnProvider,
  "coze-bot": coze_botProvider,
  "dify-workflow": dify_workflowProvider,
};
