...
/**
 * Maps Arena leaderboard categories to AIRoute task-type categories.
 *
...
/**
 * AIRoute model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name AIRoute uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to AIRoute task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known AIRoute model aliases are also expanded into additional entries.
 *
