...
const dataDir = process.env.DATA_DIR || path.join(os.homedir(), ".AIRoute");
...
if (uninstallAlreadyInProgress) {
  ...
  try {
    execSync("npm uninstall -g AIRoute", {
      stdio: "inherit",
      env: {
        ...process.env,
        AIRoute_SKIP_UNINSTALL_HOOK: "1",
      },
    });
    console.log("\n✅ AIRoute has been successfully uninstalled from your system.");
    if (!fullUninstall) {
