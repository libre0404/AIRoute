...
/**
 * Shared repair action used by both `AIRoute runtime repair` and the
 * top-level `AIRoute repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `AIRoute repair` invokes the SAME action
  // as `AIRoute runtime repair` (no duplicated logic). Surfaced in the
