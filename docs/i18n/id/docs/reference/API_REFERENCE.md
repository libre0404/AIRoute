...
Referensi lengkap untuk semua titik akhir API AIRoute.
...
| ------------------------ | --------- | ------------------------------------------------------------ |
| `X-AIRoute-No-Cache`   | Permintaan | Atur ke `true` untuk melewati cache                          |
| `X-AIRoute-Progress`   | Permintaan | Atur ke `true` untuk event progres                           |
...
| `X-AIRoute-Cache`      | Respons   | `HIT` atau `MISS` (non-streaming)                            |
| `X-AIRoute-Idempotent` | Respons   | `true` jika dideduplikasi                                    |
| `X-AIRoute-Progress`   | Respons   | `enabled` jika pelacakan progres aktif                       |
| `X-AIRoute-Session-Id` | Respons   | ID sesi efektif yang digunakan AIRoute                     |
