...
export function buildCursorInstructions({ apiBase, models }) {
  const lines = [
    ...
    "  3. Set the OpenAI API Key to your AIRoute key (AIRoute_API_KEY)",
...
export function registerSetupCursor(program) {
  program
    ...
    .description("Print the steps to point Cursor at AIRoute (chat panel; Cursor config is not file-writable)")
