...
const CODEX_KEY = "AIRoute_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "AIRoute_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the AIRoute_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
