...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-AIRoute-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-AIRoute-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-AIRoute-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-AIRoute-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-AIRoute-auth-scopes";
 ...
 * token matches this process's AIRoute_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-AIRoute-peer-ip";
 ...
 * proxy hop (e.g. AIRoute behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-AIRoute-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-AIRoute-peer-locality";
