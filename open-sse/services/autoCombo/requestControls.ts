 ...
 *
 *   X-AIRoute-Mode:   fast | balanced | quality | <raw mode-pack name>  (#6024/#6025)
 *   X-AIRoute-Budget: <max USD per request>                             (#6023)
 *
...
/**
 * Resolve the `X-AIRoute-Mode` header value into a mode-pack override.
 *
...
/**
 * Parse the `X-AIRoute-Budget` header into a hard per-request cost ceiling (USD).
