...
export function getNodeRuntimeWarning(version = process.versions.node) {
  ...
  if (support.reason === "unreleased-major") {
    return `Node.js ${support.nodeVersion} is outside the supported LTS lines. AIRoute currently supports Node.js 22.x, 24.x, 25.x, and 26.x.`;
  }

  return `Node.js ${support.nodeVersion} is outside AIRoute's approved secure runtime policy.`;
}
