...
lines.push("AIRoute System Information Report");
...
const installedGlobal = run("npm list -g AIRoute --depth=0 2>/dev/null | grep AIRoute");
lines.push(`Global npm: ${installedGlobal || "not installed globally"}`);

const pm2Status = run("pm2 list 2>/dev/null | grep AIRoute | awk '{print $4, $10, $12}'");
...
console.log(
  `📎 Attach this file when reporting issues at: https://github.com/diegosouzapw/AIRoute/issues`
);
