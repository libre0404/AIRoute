...
export default function OAuthModal({
  ...
  const startOAuthFlow = useCallback(async () => {
    ...
    try {
      ...
      // show an auth code instead of redirecting back to AIRoute.
      ...
      // 127.0.0.1:<port> callback that AIRoute never listens on (the port is
      ...
      // - Windsurf/Devin CLI (remote fallback): use localhost with AIRoute port + /auth/callback
      ...
      //   NEXT_PUBLIC_BASE_URL or AIRoute_PUBLIC_BASE_URL are configured.
      ...
      if (provider === "codex" || provider === "openai") {
        ...
        // Remote fallback: use AIRoute's port with the /auth/callback path Windsurf expects.
        ...
        // Behind reverse proxy: use actual origin (e.g., https://AIRoute.example.com/callback)
                    ...
                    <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-200">
                      ...
                      <strong>
                        {t.rich("googleOAuthWarning", {
                          ...
                          a: (c) => (
                            <a
                              href="https://github.com/diegosouzapw/AIRoute#oauth-on-a-remote-server"
                              target="_blank"
                              rel="noreferrer"
                              className="underline"
                            >
