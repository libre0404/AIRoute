---
title: "AIRoute Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# AIRoute Documentation

Navigable index of the AIRoute documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using AIRoute — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run AIRoute in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let AIRoute pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of AIRoute.
...
- [TIERS.md](guides/TIERS.md) — AIRoute tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running AIRoute under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing AIRoute remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with AIRoute.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with AIRoute.
