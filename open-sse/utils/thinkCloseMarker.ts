 ...
 * in explicitly with the request header `x-AIRoute-thinking-marker: off`,
...
export const THINKING_MARKER_HEADER = "x-AIRoute-thinking-marker";
...
/**
 * Interpret the explicit `x-AIRoute-thinking-marker` request header.
 ...
 * this request. An explicit `x-AIRoute-thinking-marker` header wins; absent
