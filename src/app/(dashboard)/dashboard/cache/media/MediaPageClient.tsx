...
import { IMAGE_PROVIDERS } from "@AIRoute/open-sse/config/imageRegistry.ts";
import { VIDEO_PROVIDERS } from "@AIRoute/open-sse/config/videoRegistry.ts";
import { MUSIC_PROVIDERS } from "@AIRoute/open-sse/config/musicRegistry.ts";
import {
...
> = {
  ...
  speech: {
    ...
    placeholder: "Hello! Welcome to AIRoute, your intelligent AI gateway...",
