 ...
 * (AIRoute_PEER_STAMP_TOKEN). Any client-supplied value of PEER_IP_HEADER is
...
export function ensurePeerStampToken() {
  process.env.AIRoute_PEER_STAMP_TOKEN ||= randomUUID();
  return process.env.AIRoute_PEER_STAMP_TOKEN;
}
