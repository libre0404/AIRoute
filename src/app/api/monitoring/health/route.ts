...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@AIRoute/open-sse/services/rateLimitManager"),
      import("@AIRoute/open-sse/services/accountFallback"),
      import("@AIRoute/open-sse/services/requestDedup.ts"),
      import("@AIRoute/open-sse/services/quotaMonitor.ts"),
      import("@AIRoute/open-sse/services/sessionManager.ts"),
