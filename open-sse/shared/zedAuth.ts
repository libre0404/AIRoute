 ...
 *
 *   1. The client (AIRoute) generates an ephemeral RSA keypair.
 ...
 *   5. AIRoute decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + AIRoute conventions. `fetch` is intentionally the
