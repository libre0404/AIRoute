...
export const CHAT_LARGE_BODY_BYTES = parsePositiveInt(
  process.env.AIRoute_CHAT_LARGE_BODY_BYTES,
  256 * 1024
);
...
export const CHAT_HARD_MAX_BODY_BYTES = parsePositiveInt(
  process.env.AIRoute_CHAT_HARD_MAX_BODY_BYTES,
  50 * 1024 * 1024
);
...
export const CHAT_HEAP_SHED_RATIO = parseRatio(process.env.AIRoute_CHAT_HEAP_SHED_RATIO, 0.75);
