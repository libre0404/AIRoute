...
// #2939: honor AIRoute_MEMORY_MB (default 512), the same knob
// `AIRoute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.AIRoute_MEMORY_MB);
