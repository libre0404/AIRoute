 ...
 *
 * Tools:
 *   1. AIRoute_pool_status   — Get pool stats for one or all providers
 *   2. AIRoute_pool_sessions — List per-session details for a provider's pool
 *   3. AIRoute_pool_reset    — Shut down and recreate a pool
 *   4. AIRoute_pool_warm     — Warm up a pool to a target session count
 *   5. AIRoute_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  ...
  AIRoute_pool_sessions: {
    name: "AIRoute_pool_sessions",
    description:
  ...
  AIRoute_browser_pool_status: {
    name: "AIRoute_browser_pool_status",
    description:
