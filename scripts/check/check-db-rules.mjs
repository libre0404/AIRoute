...
// Estas rotas NÃO consultam o DB do AIRoute (getDbInstance) — elas abrem o
// SQLite de OUTRO aplicativo (Cursor / Kiro) para auto-importar credenciais.
// Por isso NÃO podem viver em src/lib/db/ (que é o domínio do DB do AIRoute):
...
// QUALQUER novo SQL cru contra o DB do AIRoute em rotas/handlers.
