...
const MAC_DRAG_STYLE_ID = "AIRoute-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "AIRoute-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__AIRouteMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    dragRegion.className = "AIRoute-electron-drag-region";
