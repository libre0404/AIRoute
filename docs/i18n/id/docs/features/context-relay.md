...
- sebelum akun aktif habis, AIRoute menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, AIRoute menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, AIRoute menghasilkan ringkasan handoff
...
AIRoute menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, AIRoute mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
