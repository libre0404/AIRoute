...
<!-- skill:custom-start -->
<!-- Aggregated from: AIRoute-chat, AIRoute-image, AIRoute-tts, AIRoute-stt, AIRoute-embeddings, AIRoute-web-search, AIRoute-web-fetch -->
...
- `POST $AIRoute_URL/v1/chat/completions` — OpenAI format
- `POST $AIRoute_URL/v1/messages` — Anthropic Messages format
- `POST $AIRoute_URL/v1/responses` — OpenAI Responses API
...
- `POST $AIRoute_URL/v1/images/generations` — Text-to-image
- `POST $AIRoute_URL/v1/images/edits` — Image edit (mask)
- `POST $AIRoute_URL/v1/images/variations` — Variations
...
- `POST $AIRoute_URL/v1/audio/transcriptions` — multipart upload, returns text
- `POST $AIRoute_URL/v1/audio/translations` — transcribe + translate to English
