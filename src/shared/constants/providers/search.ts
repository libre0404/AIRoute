...
export const SEARCH_PROVIDERS = {
  ...
  "baidu-search": {
    ...
    color: "#2932E1",
    textIcon: "百",
    website: "https://cloud.baidu.com/doc/APIGuide/s/Ck3gl2aqo",
    hasFree: true,
    freeNote: "Free 500 queries/month via Baidu AI Cloud. Best for Chinese language web search.",
    authHint: "Baidu AI Cloud API key (from console.bce.baidu.com). Uses Bearer auth.",
    serviceKinds: ["webSearch"],
  },
  "bing-cn-search": {
    id: "bing-cn-search",
    alias: "bing-cn-search",
    ...
    hasFree: true,
    freeNote: "Free 1000 queries/month. Uses cn-north endpoint for China-low-latency.",
    authHint: "Azure Bing Search v7 subscription key (Ocp-Apim-Subscription-Key header).",
    serviceKinds: ["webSearch"],
  },
};
