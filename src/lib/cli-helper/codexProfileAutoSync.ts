...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the AIRoute_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("AIRoute_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `AIRoute setup-codex`
