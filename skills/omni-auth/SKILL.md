---
name: omni-auth
description: Manage API key authentication and session tokens. Start here to authenticate requests via Bearer token, obtain session cookies, and configure login requirements for the AIRoute API.
---
...
<!-- skill:custom-start -->
<!-- Migrated from skills/AIRoute/SKILL.md (preserved curated content) -->
...
| Capability            | Raw URL                                                                                             |
| --------------------- | --------------------------------------------------------------------------------------------------- |
| Chat / code-gen       | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-chat/SKILL.md        |
| Image generation      | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-image/SKILL.md       |
| Text-to-speech        | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-tts/SKILL.md         |
| Speech-to-text        | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-stt/SKILL.md         |
| Embeddings            | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-embeddings/SKILL.md  |
| Web search            | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-web-search/SKILL.md  |
| Web fetch             | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-web-fetch/SKILL.md   |
| MCP server (37 tools) | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-mcp/SKILL.md         |
| A2A protocol          | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-a2a/SKILL.md         |
| Routing & combos      | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-routing/SKILL.md     |
| Token compression     | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-compression/SKILL.md |
| Monitoring & health   | https://raw.githubusercontent.com/diegosouzapw/AIRoute/main/skills/AIRoute-monitoring/SKILL.md  |
...
- `401` → set/refresh `AIRoute_KEY` (Dashboard → API Keys)
