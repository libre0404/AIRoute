 ...
 * AIRoute, however, holds the streaming response until `ensureStreamReadiness`
...
const KEEPALIVE_FRAME = ENCODER.encode(": AIRoute-keepalive\n\n");
...
export type EarlyStreamKeepaliveOptions = {
   ...
   * (`: AIRoute-keepalive`). Anthropic-format routes (/v1/messages) must pass
