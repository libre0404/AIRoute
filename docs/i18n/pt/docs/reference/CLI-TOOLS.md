# CLI Tools Setup Guide — AIRoute (Português (Portugal))
...
to use **AIRoute** as the unified backend, giving you centralized key management,
...
1. Open the AIRoute dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For AIRoute integration,
> enable **Cloud Endpoint** in AIRoute Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your AIRoute key

---

## Dashboard Auto-Configuration

The AIRoute dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into AIRoute — no installation needed.
They run as internal routes and use AIRoute's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | AIRoute not running   | `pm2 start AIRoute`                      |
...
```bash
# Install all CLIs and configure for AIRoute (replace with your key and server URL)
