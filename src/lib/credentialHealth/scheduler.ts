...
function getSchedulerState() {
  if (!globalThis.__AIRouteCredentialHC) {
    globalThis.__AIRouteCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__AIRouteCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.AIRoute_DISABLE_CREDENTIAL_HEALTH_CHECK;
