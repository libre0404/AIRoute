 ...
 * `providerId` field — AIRoute's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type AIRouteRawCombo } from "../src/index.js";
...
function combo(models: AIRouteRawCombo["models"]): AIRouteRawCombo {
