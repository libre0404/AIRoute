...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@AIRoute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@AIRoute/open-sse/services/sessionManager.ts");
