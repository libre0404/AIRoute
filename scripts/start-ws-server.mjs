 ...
 *   AIRoute_DISABLE_LIVE_WS — Set to "1" or "true" to disable
 */
...
const BOOTSTRAPPED_ENV = "AIRoute_LIVE_WS_BOOTSTRAPPED";
...
async function main() {
  if (
    process.env.AIRoute_DISABLE_LIVE_WS === "1" ||
    process.env.AIRoute_DISABLE_LIVE_WS === "true"
  ) {
    console.log("[LiveWS] Disabled via AIRoute_DISABLE_LIVE_WS");
    process.exit(0);
  }
