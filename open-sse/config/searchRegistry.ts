...
export const SEARCH_PROVIDERS: Record<string, SearchProviderConfig> = {
  ...
  "baidu-search": {
    ...
    baseUrl: "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/search",
    method: "POST",
    authType: "apikey",
    authHeader: "bearer",
    costPerQuery: 0.003,
  ...
  "bing-cn-search": {
    id: "bing-cn-search",
    name: "Bing China Search",
    baseUrl: "https://api.cognitive.microsoft.cn/bing/v7.0/search",
    method: "GET",
    authType: "apikey",
