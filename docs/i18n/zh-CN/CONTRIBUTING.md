...
感谢你对 AIRoute 的关注！本文档将引导你从零开始参与项目贡献。
...
> **VPS 部署说明：** 远程镜像目录 `/usr/lib/node_modules/AIRoute/app/`
...
- **问题反馈**：[github.com/diegosouzapw/AIRoute/issues](https://github.com/diegosouzapw/AIRoute/issues)
