 ...
 * AIRoute downgrades it to `/chat/completions` — so the MCP namespaces never
...
export function shouldForceResponsesUpstream(
  ...
  if (providerSpecificData?._AIRouteForceResponsesUpstream === true) return true;
...
export function withForcedResponsesUpstream<T extends CredentialsLike>(
  ...
  return {
    ...
    providerSpecificData: {
      ...
      _AIRouteForceResponsesUpstream: true,
    },
  } as T;
}
