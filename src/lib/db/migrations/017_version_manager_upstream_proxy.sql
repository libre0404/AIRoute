...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'AIRoute'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with AIRoute
...
-- Determines whether each provider uses AIRoute's native executor,
