...
import { parseImageModel, getImageProvider } from "@AIRoute/open-sse/config/imageRegistry.ts";
 ...
 *    generated through AIRoute — we then have its `{conversationId, parentMessageId}`
