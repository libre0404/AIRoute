...
Jika Anda menemukan kerentanan keamanan di AIRoute, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/diegosouzapw/AIRoute/security/advisories/new)
...
AIRoute menerapkan model keamanan berlapis:
