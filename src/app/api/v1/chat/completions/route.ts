...
import { resolveKeepaliveThreshold } from "@AIRoute/open-sse/utils/keepaliveThreshold";
...
export async function POST(request) {
  ...
  // typical chat payloads. Toggle off via AIRoute_LOG_REQUEST_SHAPE=0.
  if (process.env.AIRoute_LOG_REQUEST_SHAPE !== "0") {
