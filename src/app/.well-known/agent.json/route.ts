...
const BASE_URL = process.env.AIRoute_BASE_URL || "http://localhost:20128";

/**
 * GET /.well-known/agent.json
 *
 * Returns the AIRoute Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "AIRoute AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 AIRoute agent skills (22 API + 20 CLI) " +
