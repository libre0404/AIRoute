...
export function isMcpDescriptionCompressionEnabled(
  ...
  if (isDisabledEnvValue(process.env.AIRoute_MCP_COMPRESS_DESCRIPTIONS)) return false;
  if (isDisabledEnvValue(process.env.AIRoute_MCP_DESCRIPTION_COMPRESSION)) return false;
