...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    AIRoute_PUBLIC_BASE_URL?: string;
    AIRoute_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    AIRoute_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    AIRoute_BASE_URL?: string;
    AIRoute_DISABLE_BACKGROUND_SERVICES?: string;
    AIRoute_PORT?: string;
