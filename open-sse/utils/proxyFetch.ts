...
const PATCH_STATE_KEY = Symbol.for("AIRoute.proxyFetch.state");
 ...
 *
 * This remains disabled unless AIRoute_CONTROL_PLANE_PROXY_DIRECT_FALLBACK is enabled
...
async function patchedFetch(
  ...
  if (
    ...
    if (process.env.AIRoute_PROXY_FETCH_DEBUG === "true") {
