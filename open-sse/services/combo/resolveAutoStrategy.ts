...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-AIRoute-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-AIRoute-Budget value in USD (#6023). */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025): X-AIRoute-Budget and
  // X-AIRoute-Mode headers (threaded via relayOptions) take precedence over
