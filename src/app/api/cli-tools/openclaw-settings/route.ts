...
const hasAIRouteConfig = (settings: any) => {
  ...
  return !!settings.models.providers["AIRoute"];
};
...
// POST - Update AIRoute settings (merge with existing settings)
export async function POST(request: Request) {
  ...
  try {
    ...
    settings.agents.defaults.model.primary = `AIRoute/${model}`;

    // Update models.providers.AIRoute
    settings.models.providers["AIRoute"] = {
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    // Remove AIRoute from models.providers
    if (settings.models && settings.models.providers) {
      delete settings.models.providers["AIRoute"];
    ...
    // Reset agents.defaults.model.primary if it uses AIRoute
    if (settings.agents?.defaults?.model?.primary?.startsWith("AIRoute/")) {
