# Dokumentasi Server A2A AIRoute (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — AIRoute sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi AIRoute.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas AIRoute. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
