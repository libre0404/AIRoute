 ...
 *
 * AIRoute → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only AIRoute-style backwards-compat aliases where users
...
// AIRoute uses dot-notation user IDs (e.g. "gpt-5.5-high").
