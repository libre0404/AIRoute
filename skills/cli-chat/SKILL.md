---
name: cli-chat
description: Send chat completions, stream responses, and start an interactive REPL session from the CLI. Supports all AIRoute providers, combo routing, and system prompt configuration.
---
