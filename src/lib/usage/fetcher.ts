...
} from "@AIRoute/open-sse/config/providerHeaderProfiles.ts";
import { applyAntigravityClientProfileHeaders } from "@AIRoute/open-sse/services/antigravityClientProfile.ts";
...
} from "@AIRoute/open-sse/executors/antigravity.ts";
import { getCreditsMode } from "@AIRoute/open-sse/services/antigravityCredits.ts";
import {
  generateAntigravityRequestId,
  getAntigravitySessionId,
} from "@AIRoute/open-sse/services/antigravityIdentity.ts";
 ...
 * Real Claude OAuth quota windows are fetched in @AIRoute/open-sse/services/usage.ts.
 */
