 ...
 * trace out of AIRoute into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The AIRoute capture source
...
const CREATOR_NAME = "AIRoute Traffic Inspector";
