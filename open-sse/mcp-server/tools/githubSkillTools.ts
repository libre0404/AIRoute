...
export const githubSkillTools = {
  AIRoute_github_skills_search: {
    name: "AIRoute_github_skills_search",
    description:
  ...
  AIRoute_github_skills_scan: {
    name: "AIRoute_github_skills_scan",
    description:
  ...
  AIRoute_github_skills_install: {
    name: "AIRoute_github_skills_install",
    description:
