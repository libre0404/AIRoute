...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set AIRouteR_ALLOW_BODY_PROJECT_OVERRIDE=1.
    ...
    const allowBodyProjectOverride = process.env.AIRoute_ALLOW_BODY_PROJECT_OVERRIDE === "1";
    ...
    // Opt-in escape hatch: set AIRoute_ALLOW_BODY_PROJECT_OVERRIDE=1.
    let projectId =
