...
const REPO = "diegosouzapw/AIRoute";
const BRANCH = "main";
...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
  ...
  },
  {
    ...
    name: "CLI Tools",
    description:
      "Manage CLI tool integrations exposed via the API. List, configure, and invoke CLI tool plugins that extend AIRoute's automation surface.",
    category: "api",
    area: "cli-tools",
    icon: "terminal",
  },
  ...
  },
  {
    ...
    name: "Cloud Sync",
    description:
      "Synchronise AIRoute configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.",
    category: "api",
    area: "sync-cloud",
    icon: "cloud_sync",
  },
  ...
  },
  {
    ...
    description:
      "Interact with AIRoute via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities.",
    category: "api",
    area: "agents-a2a",
    icon: "device_hub",
  },
  ...
  },
  {
    ...
    description:
      "Interact with the AIRoute A2A server from the CLI. Send tasks, inspect skill execution history, and test the JSON-RPC 2.0 agent-to-agent protocol interactively.",
    category: "cli",
    area: "cli-a2a",
    icon: "device_hub",
  },
