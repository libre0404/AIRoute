 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.AIRoute/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.AIRoute/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== AIRoute VPS Phase-3 Preflight ===");
