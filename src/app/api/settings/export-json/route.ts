 ...
 * Exports a legacy AIRoute-compatible JSON backup.
 */
  ...
  try {
    ...
    const exportData: Record<string, unknown> = {
      ...
      _meta: {
        ...
        version: "AIRoute-v3-legacy-export",
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="AIRoute-legacy-backup-${new Date().toISOString().replace(/[:.]/g, "-")}.json"`,
      },
    });
  } catch (error) {
