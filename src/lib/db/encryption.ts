 ...
 * The PRIMARY key is now derived with a static salt ("AIRoute-field-encryption-v1").
 ...
 * a different derived key than the static salt `"AIRoute-field-encryption-v1"`. When the
