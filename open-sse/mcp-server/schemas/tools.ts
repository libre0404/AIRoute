 ...
 *
 * Each tool wraps existing AIRoute API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "AIRoute_get_health",
  description:
    "Returns the current health status of AIRoute including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: AIRoute_get_combo_metrics ---
...
> = {
  name: "AIRoute_get_combo_metrics",
  description:
...
> = {
  ...
  description:
    "Sends a chat completion request through AIRoute's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: AIRoute_list_models_catalog ---
...
> = {
  name: "AIRoute_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "AIRoute_web_search",
  description:
    "Performs a web search using AIRoute's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "AIRoute_web_fetch",
  description:
    "Fetches and extracts content from a URL using AIRoute's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 10: AIRoute_set_budget_guard ---
...
// --- Tool 11: AIRoute_set_routing_strategy ---
...
> = {
  name: "AIRoute_set_routing_strategy",
  description:
...
// --- Tool 12: AIRoute_set_resilience_profile ---
...
> = {
  name: "AIRoute_set_resilience_profile",
  description:
...
// --- Tool 14: AIRoute_get_provider_metrics ---
...
> = {
  name: "AIRoute_get_provider_metrics",
  description:
...
// --- Tool 15: AIRoute_best_combo_for_task ---
...
> = {
  name: "AIRoute_best_combo_for_task",
  description:
...
// --- Tool 17: AIRoute_get_session_snapshot ---
...
> = {
  name: "AIRoute_get_session_snapshot",
  description:
...
// --- Tool 18: AIRoute_db_health_check ---
...
> = {
  name: "AIRoute_db_health_check",
  description:
    "Diagnoses AIRoute database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "AIRoute_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into AIRoute. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "AIRoute_compression_status",
  description:
...
> = {
  name: "AIRoute_compression_configure",
  description:
...
> = {
  name: "AIRoute_set_compression_engine",
...
> = {
  name: "AIRoute_list_compression_combos",
...
> = {
  name: "AIRoute_compression_combo_stats",
...
> = {
  name: "AIRoute_agent_skills_list",
  description:
    "List AIRoute agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "AIRoute_agent_skills_coverage",
  description:
